...
PROBES = [
    ...
    },
    {
        ...
        "name": "Apache HTTP Server 2.4.49 Path Traversal (CVE-2021-41773)",
        ...
        "cwe": "CWE-22",
        "category": "A01:2021-Broken Access Control",
        "indicators": ["root:.*:0:0:", "root:x:0:0:", "/bin/bash", "/bin/sh"],
        "remediation": "Upgrade Apache HTTP Server to version 2.4.51 or later.",
    },
    {
        "id": "cve-2021-43798-grafana",
        "name": "Grafana 8.x Directory Traversal (CVE-2021-43798)",
        ...
        "remediation": "Upgrade Grafana to version 8.3.1 or newer.",
    },
    {
        "id": "cve-2024-27198-teamcity",
        "name": "JetBrains TeamCity Auth Bypass (CVE-2024-27198)",
        "path": "/httpAuth?jsp=/app/rest/server",
        "severity": "critical",
        "cvss": 9.8,
        "cvss_vector": "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H",
        "cwe": "CWE-288",
        "category": "A07:2021-Identification and Authentication Failures",
        "indicators": ["<server", "TeamCity", "buildNumber="],
        "remediation": "Upgrade TeamCity to version 2023.11.4 or install security patch plugin.",
    },
    {
        "id": "cve-2024-1709-screenconnect",
        "name": "ScreenConnect SetupWizard Auth Bypass (CVE-2024-1709)",
        ...
        "cwe": "CWE-287",
        "category": "A07:2021-Identification and Authentication Failures",
        "indicators": ["ScreenConnect", "Setup Wizard", "Create Administrative Account"],
        "remediation": "Upgrade ConnectWise ScreenConnect to version 23.9.8 or higher.",
    },
    {
        "id": "cve-2023-28432-minio",
        "name": "MinIO Information Disclosure & Secret Leak (CVE-2023-28432)",
        ...
        "cwe": "CWE-200",
        "category": "A01:2021-Broken Access Control",
        "indicators": ["MINIO_ROOT_PASSWORD", "MINIO_SECRET_KEY", "MinioEnv"],
        "remediation": "Upgrade MinIO to RELEASE.2023-03-20T20-16-18Z or newer.",
    },
    {
        "id": "cve-2020-5902-f5-tmui",
        "name": "F5 BIG-IP TMUI Path Traversal (CVE-2020-5902)",
        "path": "/tmui/login.jsp/..;/tmui/locallb/workspace/fileRead.jsp?fileName=%2Fetc%2Fpasswd",
        "severity": "critical",
        "cvss": 9.8,
        "cvss_vector": "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H",
        "cwe": "CWE-22",
        ...
        "remediation": "Apply F5 security hotfixes or restrict TMUI access.",
    },
    {
        "id": "cve-2020-14882-weblogic",
        ...
        "cwe": "CWE-22",
        "category": "A01:2021-Broken Access Control",
        "indicators": ["WebLogic Server", "Administration Console", "Console.portal"],
        "remediation": "Apply Oracle Critical Patch Update or block /console access.",
    },
    {
        "id": "cve-2025-0108-panos-auth",
        "name": "Palo Alto PAN-OS Auth Bypass (CVE-2025-0108)",
        "path": "/unauth/php/login.php",
        "severity": "critical",
        "cvss": 9.8,
        "cvss_vector": "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H",
        "cwe": "CWE-306",
        "category": "A07:2021-Identification and Authentication Failures",
        "indicators": ["Palo Alto Networks", "pan_login", "GlobalProtect"],
        "remediation": "Upgrade PAN-OS to 11.2.3, 11.1.4, or 10.2.11.",
    },
    {
        "id": "cve-2026-2180-ollama-api",
        "name": "Ollama LLM Framework Unauthenticated API Exposure (CVE-2026-2180)",
        "path": "/api/tags",
        "severity": "critical",
        "cvss": 9.8,
        "cvss_vector": "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H",
        ...
        "indicators": ["\"models\":", "\"version\":", "ollama"],
        "remediation": "Bind Ollama to 127.0.0.1 or enforce mTLS reverse proxy authentication.",
    },
]
